/* Copied from DragonflyBSD /usr/include/rpcsvc/nfs_prot.h */
...
#else
typedef enum nfs3_ftype ftype3;
#endif
...
struct fattr3 {
        ...
        uid3 uid;
        gid3 gid;
        size3 size __attribute((packed));
        size3 used __attribute((packed));
        specdata3 rdev __attribute((packed));
        uint64 fsid __attribute((packed));
        fileid3 fileid __attribute((packed));
        nfstime3 atime __attribute((packed));
        nfstime3 mtime __attribute((packed));
        nfstime3 ctime __attribute((packed));
};
