...
ETEXI
    ...
    {
        .name       = "dsysmon",
        .args_type  = "level4_pgt:l?,init_task:l?,runqueues:l?,per_cpu_offset:l?,nr_cpu_ids:l?",
        .params     = "[level4_pgt][init_task][runqueues][per_cpu_offset][nr_cpu_ids]",
        .help       = "D-Sysmon: initialize",
        .user_print = monitor_user_noop,
        .mhandler.cmd_new = do_dsysmon,
    },
...
ETEXI

    {
        ...
        .help       = "D-Sysmon: exit",
        .user_print = monitor_user_noop,
        .mhandler.cmd_new = do_dsysmon_exit,
    },
